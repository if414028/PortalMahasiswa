...
use frontend\modules\prtm\search\PollingSearch;
...
class PollingController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            return $this->redirect(['view', 'id' => $model->id_polling]);
        } else {
    ...
    {
        if (($model = Polling::findOne($id)) !== null) {
            return $model;
        } else {
